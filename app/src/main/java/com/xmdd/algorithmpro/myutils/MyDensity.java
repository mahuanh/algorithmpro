...
public class MyDensity {
    ...
    public static void setDensity(@NonNull final Application application, float width) {
        ...
        WIDTH = width;
        MyDensity.application = application;
    ...
    private static void setAppOrientation(@Nullable Activity activity) {
      ...
      DisplayMetrics activityDisplayMetricsa = application.getResources().getDisplayMetrics();
        activityDisplayMetricsa.density = targetDensity;
        activityDisplayMetricsa.scaledDensity = targetScaledDensity;
        activityDisplayMetricsa.densityDpi = targetDensityDpi;
    }
